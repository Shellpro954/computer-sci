...
CelorF = input("do you want to mesure in celcius or farhenhite? ").lower()
if CelorF == "celcius":
    Cel = float(input("whats your temp in celcius "))
    F = (Cel * 9/5) + 32
    if F < -273.15 :
    ...
    Far = float(input("Whats your temp in fahrenhite? "))
    C = (Far - 32) * 5/9
    if C < -170 :
        print ("your temp is invaild as it is below absoulte zero")
    if C == -169.527778:
